...
<MediaList mediaListTitle="TOP ANIME" type="ANIME" perPage={24} sort={["POPULARITY_DESC"]}/>

<MediaList mediaListTitle="TOP MANGA" type="MANGA" perPage={24} sort={["POPULARITY_DESC"]}/>